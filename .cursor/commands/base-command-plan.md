...
Use `.cursor/templates/implementation-plan.template.md` as the primary output shape.

For large behavior-preserving refactors spanning multiple modules, use `.cursor/templates/refactor-plan.template.md` instead.
