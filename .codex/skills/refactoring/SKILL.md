...
Follows `.codex/rules/core.md`, `.codex/rules/engineering.md`, and `.codex/rules/code-quality.md` for behavior preservation and code quality baselines. This skill adds:
