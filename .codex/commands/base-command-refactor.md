...
- Use `plan` when the refactor spans multiple modules and needs an approved step plan before edits. For that plan output, use `.codex/templates/refactor-plan.template.md`.
...
Use `.codex/templates/refactor-summary.template.md` as the primary output shape.
