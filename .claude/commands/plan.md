...
Use `.claude/templates/implementation-plan.template.md` as the primary output shape.

For large behavior-preserving refactors spanning multiple modules, use `.claude/templates/refactor-plan.template.md` instead.
