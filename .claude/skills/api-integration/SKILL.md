...
Follows `.claude/rules/security.md`, `.claude/rules/typescript.md`, and `.claude/rules/engineering.md` for boundary safety, type safety, and compatibility baselines. This skill adds:
