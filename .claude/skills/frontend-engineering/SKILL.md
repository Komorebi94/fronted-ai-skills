...
Follows `.claude/rules/engineering.md`, `.claude/rules/security.md`, and `.claude/rules/performance.md` for baseline engineering, safety, and performance rules. This skill adds:
